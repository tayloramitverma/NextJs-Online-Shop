  ...
  if (!token) {
    return (
      <div className="center">
        ...
        <Link href={"/login/"}>
          <a>
            <button className="btn waves-effect waves-light blue">Login</button>
          </a>
        </Link>
      </div>
    );
          ...
          {cartProducts.map((item, index) => {
            ...
            return (
              <tr key={indexing}>
                <td>{indexing}</td>
                <td>
                  <img src={item.product.mediaURI} style={{ width: "50px" }} />
                  <br />
          ...
          <tr>
            <td colSpan="6">
              {cartProducts.length > 0 && (
                ...
                >
                  <button className="right btn waves-effect waves-light blue">
                    Checkout
                  </button>
                </StripeCheckout>
              )}
