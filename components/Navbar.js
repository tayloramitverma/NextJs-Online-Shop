    ...
    return(
        <nav className="nav-extended">
            <div className="nav-background">
                <div className="ea k" style={{backgroundImage:`url('./icon-seamless.png')`}}></div>
            </div>
            <div className="nav-wrapper db">
                <Link href="/"><a className="brand-logo"><i className="material-icons">camera</i> Taylor's Store</a></Link>
